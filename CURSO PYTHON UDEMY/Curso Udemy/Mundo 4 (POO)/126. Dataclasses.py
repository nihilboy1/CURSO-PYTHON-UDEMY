...
print(p1)
""" 
Aqui normalmente eu teria um retorno do tipo ''espaço da memória''
mas no caso, como estou usando a dataclass, ela ja importa pra mim o método mágico __repr__
que retorna o valor atribuido ao espaço da memória
"""
# print(p1)
# print(p1 == p2)
